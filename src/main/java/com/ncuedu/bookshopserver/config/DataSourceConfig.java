package com.ncuedu.bookshopserver.config;
...
public class DataSourceConfig {
	...
	//mapper接口所在的包
    static final String PACKAGE = "com.ncuedu.bookshopserver.mapper";
    //映射文件目录
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    //哪个包下面的类自动配置别名
    static final String ALIAS = "com.ncuedu.bookshopserver.pojo";
